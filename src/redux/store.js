...
export const getAllColumns = state => state.columns; // zwrócenie danych z magazynu (a konkretnie tablicy columns)

export const getFilteredCards = ({ cards, searchString }, columnId) =>  // destrukturyzacji obiektu state - instrukcja { cards, searchString } wyciąga z tego obiektu searchString oraz cards jako stałe;
